    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img style="height: 100%; display: inline; margin-right: 10px;" src="assets/logo.png">树莓派仪表盘</a>
            </div>

            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a target="_blank" href="https://pi4.tech">树莓派技巧</a></li>
                    <li class="dropdown">
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="footer">
                    ...
                    <p class="pull-left" style="font-size: 12px;">Powered by <a target="_blank" href="https://pi4.tech"><strong>派技术</strong></a> v<?php echo($D['version']) ?>, <a target="_blank" href="https://www.cha1024.com">CHA1024.com</a> all rights reserved.
                    </p>
                </div>
            </div>
        </div>
